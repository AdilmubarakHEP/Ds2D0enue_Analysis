#!/bin/bash
echo -e "Reverse PID and Wrong Charge"
...
# === Input directories ===
INPUT_DIR="/group/belle/users/amubarak/PID_ReverseID_WCh/Ds_${date}25_${Attempt}_ccbar_ReverseID"
SUBDIRS=("sub00" "sub01")

# === Output directory ===
OUTPUT_DIR="/group/belle/users/amubarak/02-Grid/Sample_Grid_ReverseID_WCh/Ds_${date}25_${Attempt}_ccbar_ReverseID_WCh_Chunks"
mkdir -p "$OUTPUT_DIR"
