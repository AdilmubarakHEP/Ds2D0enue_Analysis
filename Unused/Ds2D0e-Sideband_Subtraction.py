...
meta_options.m_sideband_variable = 'D0_dM'
meta_options.m_sideband_mc_files = training_data
...
plt.show()
plt.savefig("Ds2D0enue_Analysis/04-MVA/basf2/Feature_Importance.png")