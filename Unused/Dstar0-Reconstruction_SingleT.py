...
# Reconstruct D*0
#-----------------------------------------
ma.reconstructDecay(decayString='D*0:Ch1 -> [D0:kpi -> K-:loose pi+:loose ] e+:corrected', 
                    cut=Dstar0_Cut,
                    chargeConjugation=ChargeC,
                    allowChargeViolation=True,
                    path=my_path)
ma.reconstructDecay(decayString='D*0:Ch2 -> [D0:kpi -> K-:loose pi+:loose ] e+:corrected', 
                    cut=Dstar0_Cut,
                    chargeConjugation=ChargeC,
                    allowChargeViolation=True, 
                    path=my_path) 
ma.reconstructDecay(decayString='D*0:Ch3 -> [D0:kpi -> K-:loose pi+:loose ] e+:corrected', 
                    cut=Dstar0_Cut,
                    chargeConjugation=ChargeC,
                    allowChargeViolation=True,
                    path=my_path)
...
Dstar0CH1_vars += vu.create_aliases_for_selected(
                ...
                decay_string='^D*0:Ch1 -> [D0:kpi -> K-:loose pi+:loose ] e+:corrected',
                prefix=['Dstar0_1'])
Dstar0CH1_vars += vu.create_aliases_for_selected(
...
Dstar0CH1_vars += vu.create_aliases_for_selected(
                list_of_variables=['M','InvM','p','mcPDG',
                                   'mcMother(M)',
                                   'mcMother(genNMissingDaughter(11))','mcMother(genNMissingDaughter(22))'],
                decay_string='D*0:Ch1 -> [D0:kpi -> K-:loose pi+:loose ] ^e+:corrected',
                prefix=['pi0_1'])
...
Dstar0CH2_vars += vu.create_aliases_for_selected(
                list_of_variables=['M','InvM','massDifference(0)','mcPDG','isSignal','genNMissingDaughter(11)','genNMissingDaughter(22)'],
                decay_string='^D*0:Ch2 -> [D0:kpi -> K-:loose pi+:loose ] e+:corrected',
                prefix=['Dstar0_2'])
Dstar0CH2_vars += vu.create_aliases_for_selected(
                list_of_variables=['M','InvM','p','mcPDG'],
                decay_string='D*0:Ch2 -> [^D0:kpi -> K-:loose pi+:loose ] e+:corrected',
...
Dstar0CH3_vars += vu.create_aliases_for_selected(
                ...
                decay_string='^D*0:Ch3 -> [D0:kpi -> K-:loose pi+:loose ] e+:corrected',
                prefix=['Dstar0_3'])
Dstar0CH3_vars += vu.create_aliases_for_selected(
                list_of_variables=['M','InvM','p','mcPDG'],
                decay_string='D*0:Ch3 -> [^D0:kpi -> K-:loose pi+:loose ] e+:corrected',
                prefix=['D0_3'])
Dstar0CH3_vars += vu.create_aliases_for_selected(
                list_of_variables=['M','InvM','p','mcPDG','nMCDaughters','mcSecPhysProc',
                                   'mcMother(M)',
                                   'mcMother(genNMissingDaughter(11))','mcMother(genNMissingDaughter(22))'],
                decay_string='D*0:Ch3 -> [D0:kpi -> K-:loose pi+:loose ] ^e+:corrected',
                prefix=['gamma_3'])
...
# # Overall Cut:
# #------------------
ma.applyCuts('D*0:Ch1', "abs(Dstar0_1_mcPDG)==423 and genNStepsToDaughter(1)==3", path=my_path)
ma.applyCuts('D*0:Ch2', "abs(Dstar0_2_mcPDG)==423 and daughter(1,genMotherPDG)==111 and genNStepsToDaughter(1)==2", path=my_path)
ma.applyCuts('D*0:Ch3', "abs(Dstar0_3_mcPDG)==423 and daughter(1,genMotherPDG)==22 and genNStepsToDaughter(1)==2", path=my_path)
