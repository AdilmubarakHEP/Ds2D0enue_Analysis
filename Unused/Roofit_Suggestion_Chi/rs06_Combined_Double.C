...
void rs06_Combined_Double()
{
   ...
   TH1F* h_combined = (TH1F*)h2->Clone("h_combined"); // Clone h1 as the base
   ...
   RooRealVar f0("f0", "f0", 0, -1.0e+06, 1.0e+06);
   ...
   // RooChi2Var chi2("chi2", "chi2", model, data_combined, DataError(RooAbsData::Poisson));
   ...
   frame->GetYaxis()->SetRangeUser(0, 7000); // Log scale cannot have 0
   frame->Draw();
   ...
   //-------------------------------
   c->SaveAs("/home/belle2/amubarak/Ds2D0enue_Analysis/10-Suggestion/Roofit_Suggestion_Chi/Fit_Image/rs06_DeltaM_Combined_Dstar0.png");
   //=========================================================================================================================================================================//
