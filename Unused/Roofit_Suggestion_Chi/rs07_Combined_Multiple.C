...
void rs05_Combined()
{
   ...
   TFile *f_S = new TFile("/home/belle2/amubarak/Ds2D0enue_Analysis/05-ROOT/Roofit_Suggestion_Chi/Fit_Parameter/rs00_SignalPara.root");
   TFile *f_DstarP = new TFile("/home/belle2/amubarak/Ds2D0enue_Analysis/05-ROOT/Roofit_Suggestion_Chi/Fit_Parameter/rs01_DstarP.root");
   TFile *f_Dstar0 = new TFile("/home/belle2/amubarak/Ds2D0enue_Analysis/05-ROOT/Roofit_Suggestion_Chi/Fit_Parameter/rs02_Dstar0.root");
   TFile *f_D0 = new TFile("/home/belle2/amubarak/Ds2D0enue_Analysis/05-ROOT/Roofit_Suggestion_Chi/Fit_Parameter/rs03_D0.root");
   TFile *f_O = new TFile("/home/belle2/amubarak/Ds2D0enue_Analysis/05-ROOT/Roofit_Suggestion_Chi/Fit_Parameter/rs04_OtherPara.root");
   ...
   RooRealVar f0("f0", "f0", 0, -50000., 5.0e+06);
   RooRealVar f1("f1", "f1", 2.0573e+05, 1.0e+02, 3.0e+05);
   RooRealVar f2("f2", "f2", 1.7827e+05, 1.0e+02, 3.0e+05);
   // RooRealVar f2("f2", "f2", 1.7827e+05, 1.0e+02, 3.0e+05);
   RooRealVar f3("f3", "f3", 7.1229e+04, 3.0e+02, 9.0e+04);
   // RooRealVar f3("f3", "f3", 7.1229e+04, 3.0e+04, 9.0e+05);
   RooRealVar f4("f4", "f4", 5.1740e+03, 2.0e+00, 7.0e+03);
   ...
   //-------------------------------
   c->SaveAs("/home/belle2/amubarak/Ds2D0enue_Analysis/05-ROOT/Roofit_Suggestion_Chi/Fit_Image/rs07_DeltaM_Combined.png");
   //=========================================================================================================================================================================//
