...
ma.reconstructDecay(decayString='pi0:2photons -> [gamma:RD_partial -> e+:corrected ...] ?gamma',
                    ...
                    allowChargeViolation=True,
                    path=my_path)
ma.applyCuts('pi0:2photons', '', path=my_path)

# Reconstruct D*0
#-----------------------------------------
ma.reconstructDecay(decayString='D*0 -> [D0:kpi -> K-:loose pi+:loose ] [pi0:2photons -> [gamma:RD_partial -> e+:corrected ...] ?gamma]', 
                    cut=Dstar0_Cut,
                    chargeConjugation=ChargeC,
                    allowChargeViolation=True,
                    path=my_path)
...
ma.fillSignalSideParticleList(outputListName='e+:sig',
                              decayString='D*0 -> [D0:kpi -> K-:loose pi+:loose ] [pi0:2photons -> [gamma:RD_partial -> ^e+:corrected ...] ?gamma]',
                              path=roe_path)
...
Dstar0_vars += vu.create_aliases_for_selected(
                list_of_variables=['electronID','binaryPID(11,211)',
                                   ...
                                   + tracks,
                decay_string='D*0 -> [D0:kpi -> K-:loose pi+:loose ] [pi0:2photons -> [gamma:RD_partial -> ^e+:corrected ...] ?gamma]',
                prefix=['e'])

Dstar0_vars += vu.create_aliases_for_selected(
                list_of_variables=['M','InvM','p','mcPDG','genMotherPDG','nMCDaughters',
...
# ma.applyCuts('D*0:Ch2', "Dstar0_2_isSignal==1", path=my_path)
# ma.applyCuts('D*0:Ch3', "Dstar0_3_isSignal==1", path=my_path)
#/==========================================================================================================================/
# Save
#--------
