...
void rs07_Combined_Double_Dstar0()
{
...
//    RooDataSet data_4("data_4", "dataset with mass (4)", tree_4, RooArgSet(DeltaM,BS));
   ...
   *filteredData->plotOn(frame, Binning(bin));
   ...
   frame->GetYaxis()->SetRangeUser(0,8000);
   frame->Draw();
   ...
   //-------------------------------
   c->SaveAs("/home/belle2/amubarak/Ds2D0enue_Analysis/10-Suggestion/Roofit_Suggestion_Likehood_Window/Fit_Image/rs07_Combined_Double_Dstar0.png");
   //=========================================================================================================================================================================//
