...
void rs04_Other()
{
   ...
   RooDataSet *data_Other = (RooDataSet*)data.reduce("Ds_extraInfo_BkgBDT >= 0.531 && Ds_diff_D0pi >= 0.16 && Ds_diff_D0pi <= 0.45");
   ...
   // Fifth Attempt:
   //-------------------
   RooRealVar c0_FakeD0Bkg("c0_FakeD0Bkg", "coefficient #0", -4.3359e-02, -1.0, 1.0);
   RooRealVar c1_FakeD0Bkg("c1_FakeD0Bkg", "coefficient #1", -3.2218e-01, -1.0, 1.0);
   RooRealVar c2_FakeD0Bkg("c2_FakeD0Bkg", "coefficient #2", 1.1151e-01, -1.0, 1.0);
   RooRealVar c3_FakeD0Bkg("c3_FakeD0Bkg", "coefficient #3", -3.9855e-02, -1.0, 1.0);
   RooRealVar c4_FakeD0Bkg("c4_FakeD0Bkg", "coefficient #4", -1.2103e-02, -1.0, 1.0);
   RooRealVar c5_FakeD0Bkg("c5_FakeD0Bkg", "coefficient #5", -1.9751e-02, -1.0, 1.0);
   // RooRealVar c6_FakeD0Bkg("c6_FakeD0Bkg", "coefficient #6", -1.7315e-02, -1.0, 1.0);
   // RooRealVar c7_FakeD0Bkg("c7_FakeD0Bkg", "coefficient #7",  9.6963e-03, -1.0, 1.0);
   // RooRealVar c8_FakeD0Bkg("c8_FakeD0Bkg", "coefficient #8",  1.7583e-02, -1.0, 1.0);
   c0_FakeD0Bkg.setConstant(true);
   c1_FakeD0Bkg.setConstant(true);
   c2_FakeD0Bkg.setConstant(true);
   c3_FakeD0Bkg.setConstant(true);
   c4_FakeD0Bkg.setConstant(true);
   c5_FakeD0Bkg.setConstant(true);
   // c6_FakeD0Bkg.setConstant(true);
   // c7_FakeD0Bkg.setConstant(true);
   // c8_FakeD0Bkg.setConstant(true);
   RooChebychev OtherModel("OtherModel", "D0BkgModel", DeltaM, RooArgList(c0_FakeD0Bkg,c1_FakeD0Bkg,c2_FakeD0Bkg,c3_FakeD0Bkg,c4_FakeD0Bkg,c5_FakeD0Bkg));

   // Final Background Count
   //-----------------------------------------
   RooRealVar Nsig_O("Nsig_FakeD0Bkg", "#Signal events", 4.9844e+03, 4.0e+02, 6.0e+04);
   ...
   *data_Other->plotOn(frame, Binning(bin));
   ...
   w->writeToFile("/home/belle2/amubarak/Ds2D0enue_Analysis/10-Suggestion/Roofit_Suggestion_Likehood_Window/Fit_Parameter/rs04_OtherPara.root");
   //=========================================================================================================================================================================//
   c->SaveAs("/home/belle2/amubarak/Ds2D0enue_Analysis/10-Suggestion/Roofit_Suggestion_Likehood_Window/Fit_Image/rs04_DeltaM_Other.png");
   //=========================================================================================================================================================================//
   // Final Fit Status
   //---------------------------
