...
void rs03_D0()
{
   ...
   RooDataSet *data_D0 = (RooDataSet*)data.reduce("Ds_extraInfo_BkgBDT >= 0.531 && Ds_diff_D0pi >= 0.16 && Ds_diff_D0pi <= 0.45");
   // RooDataSet *data_D0 = (RooDataSet*)data.reduce("Ds_extraInfo_BkgBDT >= 0.531 && Ds_ifNANgiveX_isSignal_5==1 && Ds_diff_D0pi >= 0.1 && Ds_diff_D0pi <= 0.55");
   //=========================================================================================================================================================================//
   // B u i l d   M o d e l
   // -------------------------------------------------------------- 
   // // First Try
   ...
   // RooRealVar x00_D0Bkg("x00_D0Bkg","x00_D0Bkg", 1.2125e-01, 0.1, 0.2);
   // RooRealVar a0_D0Bkg("a0_D0Bkg","a0_D0Bkg", 3.9671e-01, 3.0e-01, 5.0e-01);
   // RooRealVar b0_D0Bkg("b0_D0Bkg","b0_D0Bkg", 1.5730e+00, 1.0e+00, 3.0e+00);    
   ...
   // RooRealVar x01_D0Bkg("x01_D0Bkg","x01_D0Bkg", 2.3638e-01, 0.13, 0.25);
   // RooRealVar a1_D0Bkg("a1_D0Bkg","a1_D0Bkg", 3.5185e+01, 3.0e+01, 5.0e+01);
   // RooRealVar b1_D0Bkg("b1_D0Bkg","b1_D0Bkg", 7.9149e+00, 7.0e+00, 9.0e+00);     
   ...
   // RooRealVar x02_D0Bkg("x02_D0Bkg","x02_D0Bkg", 1.4483e-01, 0.13, 0.2);
   // RooRealVar a2_D0Bkg("a2_D0Bkg","a2_D0Bkg", 1.5267e+00, 1.0e+00, 3.0e+00);
   // RooRealVar b2_D0Bkg("b2_D0Bkg","b2_D0Bkg", 1.0477e+01, 0.5e+01, 2.0e+01);     
   ...
   // // Add the components
   // RooRealVar f0_D0Bkg("f0_D0Bkg", "f0", 6.7979e-01, 6.0e-01, 8.0e-01);
   // RooRealVar f1_D0Bkg("f1_D0Bkg", "f1", 5.6689e-04, 0.0e-04, 10.0e-04);
   // RooRealVar f2_D0Bkg("f2_D0Bkg", "f2", 1.0052e+00, 0.5e+00, 2.0e+00);
   ...
   // Fifth Attempt:
   //-------------------
   RooRealVar c0_D0Bkg("c0_D0Bkg", "coefficient #0", 1.9947e-01, -1.0, 1.0);
   RooRealVar c1_D0Bkg("c1_D0Bkg", "coefficient #1", -3.2075e-01, -1.0, 1.0);
   RooRealVar c2_D0Bkg("c2_D0Bkg", "coefficient #2", 8.6516e-02, -1.0, 1.0);
   RooRealVar c3_D0Bkg("c3_D0Bkg", "coefficient #3", 1.6460e-03, -1.0, 1.0);
   RooRealVar c4_D0Bkg("c4_D0Bkg", "coefficient #4", -5.5657e-03 -1.0, 1.0);
   RooRealVar c5_D0Bkg("c5_D0Bkg", "coefficient #5",  1.6679e-02, -1.0, 1.0);
   // RooRealVar c6_D0Bkg("c6_D0Bkg", "coefficient #6", -5.0712e-03, -1.0, 1.0);
   // RooRealVar c7_D0Bkg("c7_D0Bkg", "coefficient #7",  9.6265e-03, -1.0, 1.0);
   // RooRealVar c8_D0Bkg("c8_D0Bkg", "coefficient #8",  7.4177e-03, -1.0, 1.0);
   ...
   RooChebychev D0BkgModel("D0BkgModel", "D0BkgModel", DeltaM, RooArgList(c0_D0Bkg,c1_D0Bkg,c2_D0Bkg,c3_D0Bkg,c4_D0Bkg,c5_D0Bkg));

   // Final Background Count
   //-----------------------------------------
   RooRealVar Nsig_D0Bkg("Nsig_D0Bkg", "#Signal events", 5.6158e+04, 6.0e+03, 8.0e+04);
   ...
   *data_D0->plotOn(frame, Binning(bin));
   ...
   w->saveSnapshot("reference_fit_D0", *params, true);
   ...
   w->writeToFile("/home/belle2/amubarak/Ds2D0enue_Analysis/10-Suggestion/Roofit_Suggestion_Likehood_Window/Fit_Parameter/rs03_D0.root");
   //=========================================================================================================================================================================//
   c->SaveAs("/home/belle2/amubarak/Ds2D0enue_Analysis/10-Suggestion/Roofit_Suggestion_Likehood_Window/Fit_Image/rs03_DeltaM_D0.png");
   //=========================================================================================================================================================================//
   // Final Fit Status
   //---------------------------
