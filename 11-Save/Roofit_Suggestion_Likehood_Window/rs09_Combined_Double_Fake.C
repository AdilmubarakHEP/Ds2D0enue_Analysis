...
void rs09_Combined_Double_Fake()
{
   ...
   RooRealVar a0_S("a0_S","a0_S", 2.4612e+00, 1.0e+00, 3.0e+00);
   RooRealVar b0_S("b0_S","b0_S", 1.5738e+02, 1.0e+02, 3.0e+02);    
   x00_S.setConstant();
   a0_S.setConstant();
   b0_S.setConstant();
   ...
   //--------------------------------------------------------------------------//
   RooRealVar f0("f0", "f0", 0, -1000000., 1000000.);
   RooRealVar f1("f1", "f1", 9.0157e+04, 8.0e+04, 10.0e+04);
   RooRealVar f2("f2", "f2", 1.7312e+05, 1.0e+05, 3.0e+05);
   RooRealVar f3("f3", "f3", 7.0367e+04, 6.0e+04, 8.0e+04);
   RooRealVar f4("f4", "f4", 4.9844e+03, 4.0e+03, 6.0e+03);
...
//    legend->AddEntry((TObject *)0, N_Dstar0, "");
   ...
   //-------------------------------
   c->SaveAs("/home/belle2/amubarak/Ds2D0enue_Analysis/10-Suggestion/Roofit_Suggestion_Likehood_Window/Fit_Image/rs09_Combined_Double_Fake.png");
   //=========================================================================================================================================================================//
