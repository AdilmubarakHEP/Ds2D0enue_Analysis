...
void rs08_Combined_Double_D0()
{
   ...
   // Merge The Datasets
   RooDataSet *mergedData = (RooDataSet*)data_3.Clone(); // Start with data1
...
//    legend->AddEntry((TObject *)0, N_Dstar0, "");
   ...
   //-------------------------------
   c->SaveAs("/home/belle2/amubarak/Ds2D0enue_Analysis/10-Suggestion/Roofit_Suggestion_Likehood_Window/Fit_Image/rs08_Combined_Double_D0.png");
   //=========================================================================================================================================================================//
