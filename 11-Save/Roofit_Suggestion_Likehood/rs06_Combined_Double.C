...
void rs06_Combined_Double()
{
   ...
   TFile *f_S = new TFile("/home/belle2/amubarak/Ds2D0enue_Analysis/10-Suggestion/Roofit_Suggestion_Likehood/Fit_Parameter/rs00_SignalPara.root");
   TFile *f_DstarP = new TFile("/home/belle2/amubarak/Ds2D0enue_Analysis/10-Suggestion/Roofit_Suggestion_Likehood/Fit_Parameter/rs01_DstarP.root");
   TFile *f_Dstar0 = new TFile("/home/belle2/amubarak/Ds2D0enue_Analysis/10-Suggestion/Roofit_Suggestion_Likehood/Fit_Parameter/rs02_Dstar0.root");
   TFile *f_D0 = new TFile("/home/belle2/amubarak/Ds2D0enue_Analysis/10-Suggestion/Roofit_Suggestion_Likehood/Fit_Parameter/rs03_D0.root");
   TFile *f_O = new TFile("/home/belle2/amubarak/Ds2D0enue_Analysis/10-Suggestion/Roofit_Suggestion_Likehood/Fit_Parameter/rs04_OtherPara.root");
   ...
   // Merge The Datasets
   RooDataSet *mergedData = (RooDataSet*)data_4.Clone(); // Start with data1
   ...
   RooRealVar f2("f2", "f2", 1.5762e+05, 0.0e+03, 3.0e+05);
   // RooRealVar f2("f2", "f2", 1.7827e+05, 1.0e+02, 3.0e+05);
   RooRealVar f3("f3", "f3", 7.1232e+04, 5.0e+04, 9.0e+05);
   // RooRealVar f3("f3", "f3", 7.1229e+04, 3.0e+04, 9.0e+05);
   RooRealVar f4("f4", "f4", 5.1778e+03, 3.0e+01, 7.0e+03);
   ...
   *filteredData->plotOn(frame, Binning(bin));
   ...
   //-------------------------------
   c->SaveAs("/home/belle2/amubarak/Ds2D0enue_Analysis/10-Suggestion/Roofit_Suggestion_Likehood/Fit_Image/rs06_DeltaM_Combined_Other.png");
   //=========================================================================================================================================================================//
