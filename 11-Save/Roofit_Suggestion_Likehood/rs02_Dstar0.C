...
void rs02_Dstar0()
{
   ...
   RooDataSet *data_Dstar0 = (RooDataSet*)data.reduce("Ds_extraInfo_BkgBDT >= 0.531 && Ds_diff_D0pi >= 0.1 && Ds_diff_D0pi <= 0.55");
   ...
   *data_Dstar0->plotOn(frame, Binning(bin));
   ...
   w->writeToFile("/home/belle2/amubarak/Ds2D0enue_Analysis/10-Suggestion/Roofit_Suggestion_Likehood/Fit_Parameter/rs02_Dstar0.root");
   //=========================================================================================================================================================================//
   c->SaveAs("/home/belle2/amubarak/Ds2D0enue_Analysis/10-Suggestion/Roofit_Suggestion_Likehood/Fit_Image/rs02_DeltaM_Dstar0.png");
   //=========================================================================================================================================================================//
   // Final Fit Status
   //---------------------------
