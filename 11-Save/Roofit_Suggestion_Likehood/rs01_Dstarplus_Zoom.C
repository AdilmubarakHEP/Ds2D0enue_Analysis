...
void rs01_Dstarplus_Zoom()
{
   ...
   // Peaking Component
   //---------------------
   RooRealVar sig_mean("sig_mean", "mean of crystal", 1.4543e-01, 1.44e-01, 1.46e-01);
   RooRealVar sig_sigmaL("sig_sigmaL", "sig_sigmaL", 3.2430e-04, 2.0e-4, 4.0e-04);
   RooRealVar sig_sigmaR("sig_sigmaR", "sig_sigmaR", 3.1950e-04, 2.0e-4, 4.0e-04);
   RooRealVar sig_alphaL("sig_alphaL", "sig_alphaL", 1.2328e+00, 1e-4, 2.0e+00);
   RooRealVar sig_alphaR("sig_alphaR", "sig_alphaR", 1.1105e+00, 1e-4, 2.0e+00);
   RooRealVar sig_nL("sig_nL", "sig_nL", 4.1755e+00, 3.0e+00, 5.0e+00);
   RooRealVar sig_nR("sig_nR", "sig_nR", 5.0952e+00, 4.0e+00, 6.0e+00);
   //  sig_mean.setConstant();
   //  sig_sigmaL.setConstant();
   //  sig_sigmaR.setConstant();
   //  sig_alphaL.setConstant();
   ...
   RooCrystalBall CrystallB("CrystallB", "sig4", DeltaM, sig_mean,sig_sigmaL,sig_sigmaR,sig_alphaL,sig_nL,sig_alphaR,sig_nR);
	...
	RooRealVar sigmean0_PBkg("sigmean0_PBkg", "mean", 0.135, 0.155);
	RooRealVar sigwidth0_PBkg("sigwidth0_PBkg", "width", 0, 0.1);
   ...
   //  sigwidth0_PBkg.setConstant();
	...
	RooRealVar sigmean1_PBkg("sigme an1_PBkg", "mean", 0.135, 0.155);
	RooRealVar sigwidth1_PBkg("sigwidth1_PBkg", "width", 0, 0.1);
   //  sigmean1_PBkg.setConstant();
   //  sigwidth1_PBkg.setConstant();
	RooGaussModel gaussm1_PBkg("gaussm1_PBkg", "Signal PDF", DeltaM, sigmean1_PBkg, sigwidth1_PBkg);

   RooRealVar f0("f0", "Fraction #1", 0, 1.0);
   RooRealVar f1("f1", "Fraction #1", 0, 1.0);
   RooRealVar f2("f2", "Fraction #1", 0, 1.0);
   // RooAddPdf PeakingBkgModel("PeakingBkgModel", "Combined Reverse Argus", RooArgList(CrystallB,gaussm0_PBkg), RooArgList(f0,f1));
   RooAddPdf PeakingBkgModel("PeakingBkgModel", "Combined Reverse Argus", RooArgList(CrystallB,gaussm0_PBkg,gaussm1_PBkg), RooArgList(f0,f1,f2));
