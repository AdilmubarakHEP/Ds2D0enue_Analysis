...
1. **Setup environment**:
   ```bash
   source /path/to/belle2/setup.sh
   ```

2. **Configure campaign** (edit `04-b2luigi/KEKCC/settings.json`):
   ```json
   {
     "date": "091225",
     "attempt": "1",
     "pi0_lists": ["eff50_May2020"],
     "control_samples": {
       "signal": true,
...
4. **Monitor progress**: Check Luigi scheduler at `http://localhost:8082`
