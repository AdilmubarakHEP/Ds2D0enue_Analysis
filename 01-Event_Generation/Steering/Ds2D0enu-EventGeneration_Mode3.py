...
ge.add_inclusive_continuum_generator(finalstate="ccbar",
                                     particles=["D_s+"],
                                     userdecfile=b2.find_file('/home/belle2/amubarak/Ds2D0enue_Analysis/01-Event_Generation/dec/Ds2D0enu-EventGeneration_Mode3.dec'),
...
# dump in MDST format
mdst.add_mdst_output(mc=True, filename='/home/belle2/amubarak/C00-Generation/ccbarDs+EventGeneration_Mode3.root', path=my_path)
