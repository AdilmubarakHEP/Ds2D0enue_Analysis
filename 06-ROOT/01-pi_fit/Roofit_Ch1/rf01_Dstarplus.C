...
void rf01_Dstarplus()
{
   ...
   // RooRealVar sigLDstarp("sigLDstarp","sL", 0.0, 0.1);
   // RooRealVar sigRDstarp("sigRDstarp","sR", 0.0, 0.1);
   // //  muDstarp.setConstant();
   // //  sigLDstarp.setConstant();
   // //  sigRDstarp.setConstant();
   // RooBifurGauss TailDstarp("TailDstarp","bifur shoulder", x, Dstarp_mean, sigLDstarp, sigRDstarp);

   // RooRealVar f0Dstarp("f0Dstarp", "Fraction #1", 0.0, 1.0);
   // // f0Dstarp.setConstant();

   // // <<< ADD THIS LINE HERE >>>
   // #include "/home/belle2/amubarak/Ds2D0enue_Analysis/05-ROOT/01-pi_fit/Roofit_Ch1/Fit_Parameter/rf01_Dstarplus_ranges.h"
   // // ^ keeps all your commented .setConstant() lines untouched and just
   // //   updates start values + ranges from the last fit snapshot.

   // RooAddPdf DstarpModel("DstarpModel", "Combined Reverse Argus", RooArgList(CrystallBDstarp,TailDstarp), RooArgList(f0Dstarp));

   // Background
   //======================================
   // Fermi function using RooGenericPdf
   RooRealVar x0("x0", "Turn-on", 0.135, 0.15);
   ...
   // Float_t N_value = NDstarp_PBkg.getValV();
   ...
   TString chi2("");
   TString NDstarp_para("");
   TString Nbkg_para("");

   chi2.Form("#chi^{2}/ndf = %.2f", chi2ndf);
   NDstarp_para.Form("N_{sig} = %.2f #pm %.2f", nsig.getValV(), nsig.getError());
   ...
   legend->AddEntry((TObject *)0, NDstarp_para, "");
   ...
   w->writeToFile("/home/belle2/amubarak/Ds2D0enue_Analysis/05-ROOT/01-pi_fit/Roofit_Ch1/Fit_Parameter/rf01_Dstarplus.root");
   //=========================================================================================================================================================================//
   c->SaveAs("/home/belle2/amubarak/Ds2D0enue_Analysis/05-ROOT/01-pi_fit/Roofit_Ch1/Fit_Image/rf01_Dstarplus.png");
   //=========================================================================================================================================================================//
   // Final Fit Status
   //---------------------------
