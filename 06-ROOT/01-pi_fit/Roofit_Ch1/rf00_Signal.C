...
void rf00_Signal()
{
   ...
   // // a0_S.setConstant();
   // // b0_S.setConstant();
   // RooFormulaVar x00prime_S("#x00prime_S", "x[0] < x[1] ? x[0] : x[1]", RooArgList(x, x00_S));     
   ...
   // RooGamma SignalModel("SignalModel", "Gamma pdf", x, gamma0_S, beta0_for_gamma_S, x00prime_S);
   ...
   RooRealVar x0("x0", "Turn-on", 0.0, 0.14);
   ...
   // X-axis
   TString x_axis ("");
   x_axis.Form("#Delta m_{#pi}[GeV/c^{2}]");
   ...
   w->writeToFile("/home/belle2/amubarak/Ds2D0enue_Analysis/05-ROOT/01-pi_fit/Roofit_Ch1/Fit_Parameter/rf00_Signal.root");
   //=========================================================================================================================================================================//
   c->SaveAs("/home/belle2/amubarak/Ds2D0enue_Analysis/05-ROOT/01-pi_fit/Roofit_Ch1/Fit_Image/rf00_Signal.png");
