...
variables = [
             'K_dr','pi_dr','K_dz','pi_dz',
             'K_omega','pi_omega',
             'K_kaonID','pi_pionID',
             'K_px','K_pz','pi_px','pi_py',
             'D0_MomentumAsymmetry','D0_useAlternativeDaughterHypothesis_M_1_K','D0_daughterAngle_0_1',
             'D0_daughterDiffOf_0_1_theta','D0_daughterDiffOf_0_1_cos_theta','D0_daughterDiffOf_0_1_phi',
             'D0_daughterMotherDiffOf_0_theta','D0_daughterMotherDiffOf_0_cos_theta','D0_daughterMotherDiffOf_0_phi',
             'D0_cos_decayAngle_1',
             'D0_chiProb','D0_flightDistance','D0_useCMSFrame_p','D0_dM']
