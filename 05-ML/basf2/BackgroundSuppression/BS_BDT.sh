...
basf2_mva_merge_mc -s /home/belle2/amubarak/C01-Simulated_Events/Ds2D0enu-Signal.root \
                   -b /home/belle2/amubarak/C03-Grid/Completed/Ds2D0e-Generic_Ds_03225_0_ccbar.root \
                   -t Dstree \
                   --fsig 0.5 \
                   --ftest 0.7 \
                   -o /home/belle2/amubarak/C02-MVA/Splits/Ds2D0e.root \
                  #  --cut "Ds_extraInfo_FakeD0BDT>=0.266"
...
#                 --datafiles /home/belle2/amubarak/C03-Grid/Completed/Ds2D0e-Generic_Ds_032325_0_ccbar.root \
#                 --treename Dstree \
#                 --outputfile C02-MVA/Ds2D0enu_MVA_allvar.root
