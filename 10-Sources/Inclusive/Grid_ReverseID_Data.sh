...
gbasf2 /home/belle2/amubarak/Ds2D0enue_Analysis/02-Reconstruction_Scripts/Data/Ds2D0e-Reconstruction_ReverseID.py -p Ds_${date}25_${Attempt}_Data_ReverseID -s light-2503-ceres -i /belle/collection/Data/RSC_proc13prompt_4S_skim_17230100_v3 --force
...
hadd -f /group/belle/users/amubarak/02-Grid/Sample_Grid_ReverseID/Ds2D0e-Generic_Ds_${date}25_${Attempt}_Data_ReverseID.root Ds_${date}25_${Attempt}_Data_ReverseID/sub00/*.root
